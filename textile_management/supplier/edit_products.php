...
<body class="home-main">
    ...
    include("../db.php");
    $sql2="select * from supplier_products where pid=".$_GET["id"];
...
if(isset($_POST["edit_product"]))
{
   ...
   $sql="update supplier_products set name='$name',price=$price,brand='$brand',category='$category',
   quantity=$quantity where pid=$id";
